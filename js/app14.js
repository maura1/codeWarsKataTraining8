...
//2. Using the filter method, continue to subract each number from the value while the result is greater than 0
//Count how many transactions(subtractions) were necessary usnig length

const minimumSteps = (numbers, value)=>[...numbers].sort((a,z)=> a-z)
                     .filter(number=> (value-=number)>0).length
